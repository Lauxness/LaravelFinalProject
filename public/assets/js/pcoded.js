...
function layout_rtl_change(value) {
    ...
    var mobBlock = document.querySelector(".pc-mob-drp");
    var headerRightBlock = document.querySelector(".navs");
    console.log(value);

    // Checking if the value is a boolean true or false, not a string.
    if (value === "1" || value === true) {
        // Strict comparison with boolean true
        rtl_flag = true;

        var header = document.querySelector(".pc-header");
        if (header) {
            header.classList.add("rtlHeaderMargin");
        }

        var sidebar = document.querySelector(".pc-sidebar");
        if (sidebar) {
            sidebar.classList.add("rtlSideBar");
        }
        ...
        if (mainContent) {
            mainContent.classList.add("rtlMainMargin");
        }
    } else if (value === false) {
        rtl_flag = false;
        ...
        var mainContent = document.querySelector(".pc-container");
        if (mainContent) {
            mainContent.classList.remove("rtlMainMargin");
        }
        var header = document.querySelector(".pc-header");
        if (header) {
            header.classList.remove("rtlHeaderMargin");
        }
        var sidebar = document.querySelector(".pc-sidebar");
        if (sidebar) {
            sidebar.classList.remove("rtlSideBar");
        }
...
function layout_change(layout) {
    ...
    if (layout == "dark") {
        dark_flag = true;
        console.log("akjshdfkjaghsfjkahskfadsf");
