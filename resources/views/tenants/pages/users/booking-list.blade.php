                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">My Booking List</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="text-end p-4 pb-0">
                            <a href="/cars/create" class="btn btn-primary">
                                <i class="ti ti-plus f-18"></i>Book a car
                            </a>
                        </div>
                            ...
                            <table class="table table-hover" id="pc-dt-simple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge {{ $booking->status == 'pending' ? 'bg-light-warning' : ($booking->status == 'confirmed' ? 'bg-light-success' : 'bg-light-danger') }} f-12">
